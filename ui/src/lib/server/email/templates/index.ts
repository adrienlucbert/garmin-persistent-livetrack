...
export const NewFollowRequestEmail: ((username: string) => EmailTemplate<typeof NewFollowRequestTemplate>) = (username: string) => ({ subject: `${m.mail_new_follow_request_subject({ username })}`, template: NewFollowRequestTemplate })
